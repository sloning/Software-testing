...
class TrigonometricFunctionsTests {
    ...
    @Test
    fun `cos(x) Taylor series test (root function for all other trigonometric functions`() = assertAll(
    ...
    @Test
    fun `sin(x) test (based on cos(x) implementation inside)`() = assertAll(
    ...
    @Test
    fun `cot(x) test (based on cos(x) and sin(x) implementation inside)`() = assertAll(
    ...
    @Test
    fun `sec(x) test (based on cos(x) implementation inside)`() = assertAll(
